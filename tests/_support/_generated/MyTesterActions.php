<?php  //[STAMP] 2f378c7c0a5cf3d5ec233e7885be01b5
...
trait MyTesterActions
{
     ...
     *
     *
     * @see \Helper\MyHelper::checkImageChange()
     */
    public function checkImageChange($identifier, $elementID, $count = 3, $wait = 1) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkImageChange', func_get_args()));
    }
     ...
     *
     *
     * @see \Helper\MyHelper::getImageName()
     */
    public function getImageName(\Codeception\TestInterface $test, $identifier) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('getImageName', func_get_args()));
    }
